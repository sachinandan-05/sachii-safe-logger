...
export const SENSITIVE_PATTERNS: Record<string, SensitivePattern> = {
    ...
    creditCardFormatted: {
        pattern: PATTERNS.CREDIT_CARD_FORMATTED,
        priority: 1,
    ...
    privateKey: {
        pattern: PATTERNS.PRIVATE_KEY,
        priority: 1,
        description: "Private keys"
    },
    password: {
        pattern: PATTERNS.PASSWORD_FIELD,
        priority: 1,
        description: "Passwords in log strings"
    },
    basicAuth: {
        pattern: PATTERNS.BASIC_AUTH,
        priority: 1,
        description: "Basic auth headers"
    },
    urlWithCredentials: {
        pattern: PATTERNS.URL_WITH_CREDENTIALS,
        priority: 1,
